...
import 'package:mapbox_starter_pack/main.dart';
import 'package:mapbox_starter_pack/screens/prepare_ride.dart';

import '../helpers/shared_prefs.dart';

class SreachLocationField extends StatefulWidget {
  final bool isDestination;
  final TextEditingController textEditingController;

  const SreachLocationField({
    Key? key,
  ...
  @override
  State<SreachLocationField> createState() => _SreachLocationFieldSate();
}

class _SreachLocationFieldSate extends State<SreachLocationField> {
